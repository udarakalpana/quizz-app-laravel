                ...
                <div class="p-6 text-gray-900">
                    <form class="w-3/4" method="POST" action="{{route('update-question', [$question->id])}}">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="answer1" name="answer1" value="{{$answer1}}"  class="text-input" required />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="answer2" name="answer2" value="{{$answer2}}" class="text-input" required />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="answer3" name="answer3" value="{{$answer3}}" class="text-input" required />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="answer4" name="answer4" value="{{$answer4}}" class="text-input" required />
